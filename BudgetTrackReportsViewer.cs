...
namespace FMIS
{
    public partial class BudgetTrackReportsViewer : Form
    {
        ...
        private void BudgetTrackReportsViewer_Load(object sender, EventArgs e)
        {

            //budgetReportViewer.SetDisplayMode(DisplayMode.PrintLayout);
            budgetReportViewer.ZoomMode = ZoomMode.Percent;
            budgetReportViewer.ZoomPercent = 100;
